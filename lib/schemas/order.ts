...
export const orderSchema = z.object({
  ...
  current_price: z.number({ error: "Preço deve ser maior que zero" }).positive("Preço deve ser maior que zero"),
  needs_price_update: z.boolean({ error: "Selecione uma opção" }),
